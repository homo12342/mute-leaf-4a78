...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/mute-leaf-4a78)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/mute-leaf-4a78
```

A live public deployment of this template is available at [https://mute-leaf-4a78.templates.workers.dev](https://mute-leaf-4a78.templates.workers.dev)
